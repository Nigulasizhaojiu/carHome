 ...
 */
public class DiscoverRvHeadAdapter extends RecyclerView.Adapter<DiscoverRvHeadAdapter.ViewHolder> {
    ...
    public DiscoverRvHeadAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.discover_rv_head_list,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            iv = (ImageView) itemView.findViewById(R.id.iv_discover_head_list);
            title = (TextView) itemView.findViewById(R.id.title_discover_head_list);
            text = (TextView) itemView.findViewById(R.id.text_discover_head_list);
            price = (TextView) itemView.findViewById(R.id.price_discover_head_list);
            fctPrice = (TextView) itemView.findViewById(R.id.fctprice_discover_head_list);
        }
    }
}
