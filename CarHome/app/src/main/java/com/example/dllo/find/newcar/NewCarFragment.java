...
import com.example.dllo.find.newcar.hot.HotBrandAdapter;
import com.example.dllo.find.newcar.hot.HotBrandBean;
import com.example.dllo.find.newcar.hot.MainCarAdapter;
import com.example.dllo.find.newcar.hot.MainCarBean;
...
public class NewCarFragment extends BaseFragment{
    private String MAINCAR_URL ="http://183.232.160.141/adnewnc.app.autohome.com.cn/advert_v7.0.0/ad/infoad.ashx?pageid=cee6fa23-52bc-4547-9ae9-ab0bc02d36d8&cityid=0&mac=74%3Aac%3A5f%3A6d%3A3c%3A93&networkid=0&appid=2&idfa=0&devicebrand=360&deviceid=860954030358581&lng=121.550946&devicemodel=1501_M02&platform=2&adtype=1&gps_city=210200&version=7.0.7&isretry=0&provinceid=210000&lat=38.889732";
    private String NEWCAR_BRAND_URL ="http://223.99.255.20/cars.app.autohome.com.cn/cars_v5.7.0/cars/brands-pm2-ts635966571635589297.json";
    private String HOTBRAND_URL = "http://183.232.160.141/cars.app.autohome.com.cn/dealer_v6.0.0/dealer/hotbrands-pm2.json";
    ...
    private void requestInternetCarBrandSort() {
        GsonRequest<NewCarBean> gsonRequest = new GsonRequest<NewCarBean>(NEWCAR_BRAND_URL, NewCarBean.class, new Response.Listener<NewCarBean>() {
...
//                adapter.setCars(carPic);
    ...
    private void requestInterntMainCar() {
        GsonRequest<MainCarBean> gsonRequest = new GsonRequest<MainCarBean>(MAINCAR_URL, MainCarBean.class, new Response.Listener<MainCarBean>() {
            @Override
    ...
    private void requestInternetHotBran() {
        GsonRequest<HotBrandBean> gsonRequest = new GsonRequest<HotBrandBean>(HOTBRAND_URL, HotBrandBean.class, new Response.Listener<HotBrandBean>() {
            @Override
